...
if($_SERVER['REQUEST_METHOD']=='POST'){
	...
	$errores ='';
	if(empty($usuario) or empty($password) or empty($roll)){
	...
	if($errores==''){
$statement = $conexion->prepare(
			'INSERT INTO usuarios(id, usuario, password, nombres, apellidos, roll) VALUES
            (null,:usuario,:password, :nombres, :apellidos, :roll)');
