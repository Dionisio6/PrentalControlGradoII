			...
			<?php include 'plantillas/nav.php'; ?>
				<article>
					...
					<form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']) ?>" method="post">
                        ...
                        <input type="date" name="citfecha" placeholder="Fecha:" value="<?php echo $cita['citfecha'];?>" required/>
                        <label>Hora:</label>
                        ...
                        <textarea placeholder="Observacion:" name="citobservaciones" value="<?php echo $cita['citobservaciones'];?>"></textarea>
