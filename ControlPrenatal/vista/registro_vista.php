...
<label class="login2 pull-right pull-right-pro">Usuario</label>        </div>
...
<input type="text" class="form-control" name="apellidos" placeholder="Apellidos" />
 ...
 <label  class="login2 pull-right pull-right-pro">Seleccione Privilegio</label>                                                   
<div class="col-lg-5 col-md-5 col-sm-5 col-xs-12">
<div class="form-select-list">
<select class="form-control custom-select-value" name="roll">
...
<a href="vista/registro_vista.php"><button class="btn btn-sm btn-primary login-submit-cs" type="submit">Registrar</button></a>
</div>
</div>
</div>
                                                        </div>
