                                                ...
                                                <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']) ?>" method="post">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-5 col-md-5 col-sm-5 col-xs-12" >
                                                                <div class="input-group date">
                                                                    <input type="date" disabled class="form-control" name="fechacon" value="<?php echo $consulta['fechacon'];?>">
                                                    ...
                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-5 col-md-5 col-sm-5 col-xs-12">
                                                                <input type="number" disabled class="form-control"  name="identificacion" placeholder="Cedula o Pasaporte" value="<?php echo $consulta['identificacion'];?>" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-5 col-md-5 col-sm-5 col-xs-12">
                                                                <input type="text" disabled class="form-control" name="nombre" placeholder="Nombre(s)" value="<?php echo $consulta['nombre'];?>" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-5 col-md-5 col-sm-5 col-xs-12">
                                                                <input type="text" disabled class="form-control" name="apellidos" placeholder="Apellido(s)" value="<?php echo $consulta['apellidos'];?>" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-5 col-md-5 col-sm-5 col-xs-12">
                                                                <input type="number" name="edad" disabled class="form-control" placeholder="Edad" value="<?php echo $consulta['edad'];?>"/>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-5 col-md-5 col-sm-5 col-xs-12">
                                                                <div class="input-group">
                                                                    <input type="text" disabled class="form-control" name="peso" placeholder="Peso" value="<?php echo $consulta['peso'];?>">
                                                    ...
                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-5 col-md-5 col-sm-5 col-xs-12">
                                                                <input type="text" disabled class="form-control" name="tenar" placeholder="Max/Min" value="<?php echo $consulta['tenar'];?>"/>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-5 col-md-5 col-sm-5 col-xs-12">
                                                                <input type="text" disabled class="form-control" name="alut" placeholder="Altura Uterina" value="<?php echo $consulta['alut'];?>"/>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-5 col-md-5 col-sm-5 col-xs-12">
                                                                <input type="text" disabled class="form-control" name="presen" placeholder="Presentacion" value="<?php echo $consulta['presen'];?>"/>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-5 col-md-5 col-sm-5 col-xs-12">
                                                                <input type="text" disabled class="form-control" name="fcf" placeholder="F.C.F Latidos por Min." value="<?php echo $consulta['fcf'];?>"/>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-5 col-md-5 col-sm-5 col-xs-12">
                                                                <input type="text" disabled class="form-control" name="movf" placeholder="Movimiento Fetal" value="<?php echo $consulta['movf'];?>"/>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-5 col-md-5 col-sm-5 col-xs-12">
                                                                <input type="text" disabled class="form-control" name="ede" placeholder="Edema" value="<?php echo $consulta['ede'];?>"/>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-5 col-md-5 col-sm-5 col-xs-12">
                                                                <input type="text" disabled class="form-control" name="vari" placeholder="Varices" value="<?php echo $consulta['vari'];?>"/>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group-inner">
                                                    ...
                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-5 col-md-5 col-sm-5 col-xs-12">
                                                                <input type="text" disabled class="form-control" placeholder="Observacion" name="obser" value="<?php echo $consulta['obser'];?>"/>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </form>
