...
if(!$medicos)
	$mensaje .= 'No hay medicos registardos!';
?>
...
<li><a  href="medicos.php"><i class="fa fa-list sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Lista de Doctores</span></a></li>
                            </ul>
                        </li>
                                                ...
                                                <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']) ?>" method="post">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-5 col-md-5 col-sm-5 col-xs-12" >
                                                                <div class="input-group date">
                                                                    <input type="date" class="form-control" value="10/04/2017" name="fechacon">
                                                    ...
                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-5 col-md-5 col-sm-5 col-xs-12">
                                                                <input type="text" class="form-control" name="tenar" placeholder="Max/Min" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-5 col-md-5 col-sm-5 col-xs-12">
                                                                <input type="text" class="form-control" name="alut" placeholder="Altura Uterina" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-5 col-md-5 col-sm-5 col-xs-12">
                                                                <input type="text" class="form-control" name="presen" placeholder="Presentacion" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-5 col-md-5 col-sm-5 col-xs-12">
                                                                <input type="text" class="form-control" name="fcf" placeholder="F.C.F Latidos por Min." />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-5 col-md-5 col-sm-5 col-xs-12">
                                                                <div class="form-select-list">
                                                                    <select class="form-control custom-select-value" name="movf" placeholder="Movimiento Fetal">
                                                                        <option>Si</option>
                                                                        <option>No</option>
                                                                    </select>
                                                                </div>
                                                    ...
                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-5 col-md-5 col-sm-5 col-xs-12">
                                                                <div class="form-select-list">
                                                                    <select class="form-control custom-select-value" name="ede" placeholder="Edema">
                                                                        <option>Si</option>
                                                                        <option>No</option>
                                                                    </select>
                                                                </div>
                                                    ...
                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-5 col-md-5 col-sm-5 col-xs-12">
                                                                <div class="form-select-list">
                                                                    <select class="form-control custom-select-value" name="vari" placeholder="Varices">
                                                                        <option>Si</option>
                                                                        <option>No</option>
                                                                    </select>
                                                                </div>
                                                    ...
                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-5 col-md-5 col-sm-5 col-xs-12">
                                                                <div class="form-select-list">
                                                                    <select class="form-control custom-select-value" name="medicos" >  
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-3">
                                                                    <div class="login-horizental cancel-wp pull-left">
                                                                        ...
                                                                        <a href="vista/consul_vista.php"><button class="btn btn-sm btn-primary login-submit-cs" type="submit">Guardar Datos</button></a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
