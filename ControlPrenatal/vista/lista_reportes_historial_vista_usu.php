...
&emsp;&emsp;&emsp;<a href="historiapaciente_usu.php" class="agregar"><button type="button" class="btn btn-custon-rounded-two btn-white">Agregar Nuevo Historial</button></a>
									</div>
									<br>
