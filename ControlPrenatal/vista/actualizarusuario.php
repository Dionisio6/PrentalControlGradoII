...
<li><a  href="reportesantecedentes.php"><i class="fa fa-file-pdf-o sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Antecedentes Clinicos</span></a></li>
                            </ul>
                        </li>
                        <li>
...
<input type="text" class="form-control" name="usuario" placeholder="Usuario" value="<?php echo $user['usuario'];?>" autofocus />
                                                            </div>
                                                        </div>
                                                    </div>
<div class="form-group-inner">
...
<div class="row">
<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
<label class="login2 pull-right pull-right-pro">Repita su contraseña</label>
                                                            </div>
<div class="col-lg-5 col-md-5 col-sm-5 col-xs-12">
<input type="text" class="form-control" name="password2" placeholder="Repita su contraseña"/>
                                                            </div>
                                                        </div>
                                                    </div>
<div class="form-group-inner">
...
<div class="col-lg-5 col-md-5 col-sm-5 col-xs-12">
<input type="text" class="form-control" name="nombres" placeholder="Nombre(s)" value="<?php echo $user['nombres'];?>"/>
                                                            </div>
                                                        </div>
                                                    </div>
<div class="form-group-inner">
...
<div class="col-lg-5 col-md-5 col-sm-5 col-xs-12">
<input type="text" class="form-control" name="apellidos" placeholder="Apellidos" value="<?php echo $user['apellidos'];?>"/>
                                                            </div>
                                                        </div>
                                                    </div>
...
<a href="vista/registro_vista.php"><button class="btn btn-sm btn-primary login-submit-cs" type="submit">Actualizar</button></a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
