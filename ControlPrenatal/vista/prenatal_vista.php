...
$consulta = $conexion -> prepare("
    SELECT * FROM historiaperinatal WHERE status <> 0");
...
<head>
    ...
    <script >
         function delete_historia(id_to_delete){
...
<li><a href="line-charts.html">Lista de Medico</a>
                                                </li>
                                            </ul>
                                        </li>
...
&emsp;&emsp;&emsp;<a href="historiapaciente.php" class="agregar"><button type="button" class="btn btn-custon-rounded-two btn-white">Agregar Nuevo Historial</button></a>
...
<?php echo "<td class='centrar'>"."<a href='actualizarhistorialpre.php?idembara=".$Sql['idembara']."' class='editar class= btn btn-custon-rounded-two btn-warning' >Editar</a>". "</td>"; ?>

<td><a class="btn btn-custon-rounded-two btn-danger" onclick="delete_historia(<?php echo  $Sql['idembara']; ?>)" href="#">Eliminar</a></td>
