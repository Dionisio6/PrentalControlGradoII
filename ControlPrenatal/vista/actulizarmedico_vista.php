...
<input type="number" class="form-control"  name="identificacion" placeholder="Cedula o Pasaporte" value="<?php echo $medico['medidentificacion'];?>" />
                                                            </div>
                                                        </div>
                                                    </div>
...
<input type="text" class="form-control" name="nombres" placeholder="Nombre(s)" value="<?php echo $medico['mednombres'];?>"/>
                                                            </div>
                                                        </div>
                                                    </div>
...
<input type="text" class="form-control" name="apellidos" placeholder="Apellido(s)" value="<?php echo $medico['medapellidos'];?>"/>
                                                            </div>
                                                        </div>
                                                    </div>
...
<input type="email" class="form-control" name="correo" placeholder="Correo@gmail.com" value="<?php echo $medico['medcorreo'];?>"/>
                                                            </div>
                                                        </div>
...
<input type="number" class="form-control" name="telefono" placeholder="Telefono" value="<?php echo $medico['medtelefono'];?>" />
</div>
					                                        </div>
					                                    </div>
					                                </div>
...
<a href="vista/medicos_vista.php"><button class="btn btn-sm btn-primary login-submit-cs" type="submit" name="enviar" >Actualizar Datos</button></a>
