...
<li><a  href="medicos.php"><i class="fa fa-list sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Lista de Medico</span></a></li>
                            </ul>
                        </li>
                                    ...
                                    <ul class="mobile-menu-nav">
                                        ...
                                        <li><a data-toggle="collapse" data-target="#Chartsmob" href="#">Medicos <span class="admin-project-icon adminpro-icon adminpro-down-arrow"></span></a>
                                            <ul id="Chartsmob" class="collapse dropdown-header-top">
                                                <li><a href="bar-charts.html">Agregar Doctor</a>
                                                </li>
                                                <li><a href="line-charts.html">Lista de Doctores</a>
                                                </li>
                                            </ul>
                                        </li>
                                        <li><a data-toggle="collapse" data-target="#Tablesmob" href="#">Especialidades <span class="admin-project-icon adminpro-icon adminpro-down-arrow"></span></a>
                                            <ul id="Tablesmob" class="collapse dropdown-header-top">
                                                <li><a href="static-table.html">Agregar Especialidad</a>
                                                </li>
                                                <li><a href="data-table.html">Lista de Especialidades</a>
                                                </li>
                                            </ul>
                                        </li>
                            ...
                            <div class="sparkline12-graph">
                                <div class="basic-login-form-ad">
                                    ...
                                    <div class="col-lg-5 col-md-5 col-sm-5 col-xs-12">
                                        <h3><?php echo $consulta['nombre'];?> <?php echo $consulta['apellidos'];?>&emsp;<?php echo $consulta['identificacion'];?></h3>
                                        <br>
                                    </div>
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="all-form-element-inner">
                                                ...
                                                <input type="hidden" name="id" value="<?php echo $consulta['idconsul'];?>" />
                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                                <label class="login2 pull-right pull-right-pro">Fecha de Consulta</label>
                                                            </div>
                                                            <div class="col-lg-5 col-md-5 col-sm-5 col-xs-12" >
                                                                <div class="input-group date">
                                                                    <input type="date" class="form-control" name="fechacon" value="<?php echo $consulta['fechacon'];?>">
                                                    ...
                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-5 col-md-5 col-sm-5 col-xs-12">
                                                                <input type="number"  class="form-control"  name="identificacion" placeholder="Cedula o Pasaporte" value="<?php echo $consulta['identificacion'];?>" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-5 col-md-5 col-sm-5 col-xs-12">
                                                                <input type="text" class="form-control" name="nombre" placeholder="Nombre(s)" value="<?php echo $consulta['nombre'];?>" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-5 col-md-5 col-sm-5 col-xs-12">
                                                                <input type="text" class="form-control" name="apellidos" placeholder="Apellido(s)" value="<?php echo $consulta['apellidos'];?>" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-5 col-md-5 col-sm-5 col-xs-12">
                                                                <input type="number"  class="form-control"  name="edad"  placeholder="Edad" value="<?php echo $consulta['edad'];?>" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                                <label class="login2 pull-right pull-right-pro">Peso</label>
                                                            </div>
                                                            <div class="col-lg-5 col-md-5 col-sm-5 col-xs-12">
	                                                            <div class="input-group">
	                                                                <input type="number"  class="form-control"  name="peso" placeholder="Peso" value="<?php echo $consulta['peso'];?>" />
                                                    ...
                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                                <label class="login2 pull-right pull-right-pro">Presion Arterial</label>
                                                            </div>
                                                            <div class="col-lg-5 col-md-5 col-sm-5 col-xs-12">
                                                                <input type="text" class="form-control" name="tenar" placeholder="Max/Min" value="<?php echo $consulta['tenar'];?>"/>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                                <label class="login2 pull-right pull-right-pro">Altura Uterina</label>
                                                            </div>
                                                            <div class="col-lg-5 col-md-5 col-sm-5 col-xs-12">
                                                                <input type="text" class="form-control" name="alut" placeholder="Altura Uterina" value="<?php echo $consulta['alut'];?>"/>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                                <label class="login2 pull-right pull-right-pro">Presentacion</label>
                                                            </div>
                                                            <div class="col-lg-5 col-md-5 col-sm-5 col-xs-12">
                                                                <input type="text" class="form-control" name="presen" placeholder="Presentacion" value="<?php echo $consulta['presen'];?>"/>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                                <label class="login2 pull-right pull-right-pro">F.C.F Latidos por Min.</label>
                                                            </div>
                                                            <div class="col-lg-5 col-md-5 col-sm-5 col-xs-12">
                                                                <input type="text" class="form-control" name="fcf" placeholder="F.C.F Latidos por Min." value="<?php echo $consulta['fcf'];?>"/>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                                <label class="login2 pull-right pull-right-pro">Movimeiento Fetal</label>
                                                            </div>
                                                            <div class="col-lg-5 col-md-5 col-sm-5 col-xs-12">
                                                                <div class="form-select-list">
                                                                    <select class="form-control custom-select-value" name="movf" placeholder="Movimiento Fetal" value="<?php echo $consulta['movf'];?>">
                                                                        <option>Si</option>
                                                                        <option>No</option>
                                                                    </select>
                                                                </div>
                                                    ...
                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                                <label class="login2 pull-right pull-right-pro">Edema</label>
                                                            </div>
                                                            <div class="col-lg-5 col-md-5 col-sm-5 col-xs-12">
                                                                <div class="form-select-list">
                                                                    <select class="form-control"  name="ede" placeholder="Edema" value="<?php echo $consulta['ede'];?>">
                                                                        <option>Si</option>
                                                                        <option>No</option>
                                                                    </select>
                                                                </div>
                                                    ...
                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                                <label class="login2 pull-right pull-right-pro">Varices</label>
                                                            </div>
                                                            <div class="col-lg-5 col-md-5 col-sm-5 col-xs-12">
                                                                <div class="form-select-list">
                                                                    <select class="form-control custom-select-value" name="vari" placeholder="Varices" value="<?php echo $consulta['vari'];?>">
                                                                        <option>Si</option>
                                                                        <option>No</option>
                                                                    </select>
                                                                </div>
                                                    ...
                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                                <label class="login2 pull-right pull-right-pro">Medico</label>
                                                            </div>
                                                            <div class="col-lg-5 col-md-5 col-sm-5 col-xs-12">
                                                                <input type="text" disabled class="form-control" name="medicos" value="<?php echo $consulta['medicos'];?>"/>
                                                            </div>
                                                        </div>
                                                    </div>
                                           			 <div class="form-group-inner">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-5 col-md-5 col-sm-5 col-xs-12">
                                                                <input type="text" class="form-control" placeholder="Observacion" name="obser" value="<?php echo $consulta['obser'];?>"/>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group-inner">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-3">
                                                                    <div class="login-horizental cancel-wp pull-left">
                                                                        <a href="vista/consul_vista.php"><button class="btn btn-white" type="submit" >Cancelar</button>

                                                                        <a href="vista/consul_vista.php"><button class="btn btn-sm btn-primary login-submit-cs" type="submit">Actualizar Datos</button></a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
