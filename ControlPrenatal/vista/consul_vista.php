...
$consulta = $conexion -> prepare("
    SELECT * FROM consulta WHERE status <> 0");

$consulta ->execute();
$consulta = $consulta ->fetchAll();
if(!$consulta){
    $mensaje .= 'NO HAY CONSULTAS PREVIAS';
}
?>
...
<script >
         function delete_consul(id_to_delete){
  var confirmation = confirm('¿Esta seguro que desea eliminar el registro con el ID' + id_to_delete + '?');

         if (confirmation) {

 window.location = "elimar_logica_a.php?idconsul=" + id_to_delete;
                            ...
                            <div class="sparkline13-graph">
                                <div class="datatable-dashv1-list custom-datatable-overright">
									...
									<div class="button-style-two btn-mg-b-10">
	                                    &emsp;&emsp;&emsp;<a href="agregarconsulta.php" class="agregar"><button type="button" class="btn btn-custon-rounded-two btn-white">Agregar Consulta</button></a>
									</div>
									<br>
                                    <table id="table" data-toggle="table" >
                                        ...
                                        <?php foreach ($consulta as $Sql): ?>
											<tr >
                                                ...
                                                <?php echo "<td class='mayusculas'>". $Sql['fechacon']. "</td>"; ?>
                                                ...
                                                <?php echo "<td class='mayusculas'>". $Sql['edad']. "</td>"; ?>
                                                <?php echo "<td class='mayusculas'>". $Sql['medicos']. "</td>"; ?>
                                                <?php echo "<td class='centrar'>"."<a href='actualizarconsulta.php?idconsul=".$Sql['idconsul']."' class='editar class= btn btn-custon-rounded-two btn-warning'>Editar</a>". "</td>"; ?>
<td><a class="btn btn-custon-rounded-two btn-danger" onclick="delete_consul(<?php echo  $Sql['idconsul']; ?>)" href="#">Eliminar</a></td>

<?php echo "<td class='centrar'>"."<a href='verconsulta.php?idconsul=".$Sql['idconsul']."' class='eliminar class= btn btn-custon-rounded-two btn-primary'>Ver</a>". "</td>"; ?>
											</tr>
										<?php endforeach; ?>
                                        </tbody>
                                    </table>
