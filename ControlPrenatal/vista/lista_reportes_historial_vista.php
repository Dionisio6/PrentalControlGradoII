...
<li><a href="bar-charts.html">Agregar Medioc</a>
                                                </li>
                                    ...
                                    <table id="table" data-toggle="table" >
                                        ...
                                        <?php foreach ($consulta as $Sql): ?>
											<tr >
												...
												<?php echo "<td class='centrar'>"."<a href='historiaprenatalpdf.php?idembara=".$Sql['idembara']."' class='eliminar class= btn btn-custon-rounded-two btn-primary'>PDF</a>". "</td>"; ?>
