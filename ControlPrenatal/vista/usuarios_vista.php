...
<ul id="Appviewsmob" class="collapse dropdown-header-top">
<li><a href="registrarusuarios.php">Nuevo Usuario</a>
                                                </li>
...
&emsp;&emsp;&emsp;<a href="registrarusuarios.php" class="agregar"><button type="button" class="btn btn-custon-rounded-two btn-white">Agregar Usuario</button></a>
									</div>
									<br>
...
<?php echo "<td class='centrar'>"."<a href='actualizarusuario.php?id=".$Sql['id']."' class='editar btn btn-custon-rounded-two btn-warning'>Editar</a>". "</td>"; ?>

<td><a class="btn btn-custon-rounded-two btn-danger" onclick="delete_usu(<?php echo  $Sql['id']; ?>)" href="#">Eliminar</a></td>
