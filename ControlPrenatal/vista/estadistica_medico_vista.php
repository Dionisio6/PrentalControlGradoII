...
<li><a href="estadistica_mes.php">Pacientes por Meses</a>
                                </li>
<li><a href="estadistica_medico.php">Consultaspor Medicos</a>
                                                </li>
                                            </ul>
                                        </li>
...
<li><a href="advance-form-element.html">Lista de Usuarios</a>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="charts-single-pro responsive-mg-b-30">
                            <div class="alert-title">
                            	<h2 align="center">Atendidos por cada Medicos</h2>
                                <div id="bar1-chart">
    ...
    <script src="js/charts/bar-chart2.js"></script>
        <!-- tab JS
        ============================================ -->
