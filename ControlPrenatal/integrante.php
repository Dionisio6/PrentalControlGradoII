...
<li><a  href="index.html"><i class="fa fa-file-pdf-o sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Total de Consultas</span></a></li>
                            </ul>
                        </li>
                        <li>
...
<li><a  href="index.html"><i class="fa fa-bar-chart sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Pacientes</span></a></li>

<li><a  href="index.html"><i class="fa fa-bar-chart sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Consultas</span></a></li>
                            </ul>
                        </li>
                        <li>
...
<li><a href="basic-form-element.html">Pacientes</a>
                                                </li>
<li><a href="advance-form-element.html">Consultas</a>
                                                </li>
                                            </ul>
                                        </li>
...
<h3>¿Qué es Prenatal Control?</h3>
<p>Prenatal Control es una herramienta destinada a facilitar la gestión y organización de los datos  de las gestantes. Al ser una herramienta digital es práctica y reduce el tiempo de cada consulta. El acceso a la información es rápido y de forma sencilla.
<p> 
...
<h4><strong>Misión</h4></strong> 
<p>
Permitir una mejor gestión y organización en los datos de la gestante, así como también facilitar el manejo de la información a los médicos.
</p>

<h4><strong>Visión</h4></strong> </strong>
<p>Disponer de la información de una forma más rápida y asertiva.  Brindar una mejor atención a la gestante.</p>
<br>
<p><em>Dionisio Marquez  CI.: 25.129.975  Proyecto de Grado II</em></p>  
                            </div>
                        </div>
                    </div>
                </div>
